...
<div class="container mx-auto px-6 py-8 bg-white rounded-lg shadow-md">
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-gray-700">Registrar Corresponsal</h2>
        <p class="text-gray-500">Completa los siguientes campos para agregar una nueva corresponsal.</p>
    </div>

    <!-- Formulario -->
    <form action="<?= base_url('corresponsales'); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="comision" id="comision" required 
                       class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div>
        ...
        <div class="flex justify-center mt-6">
            <a href="<?= base_url('corresponsales');?>"></a>
